					...
					if (userReply.equalsIgnoreCase("Bike")) {
						...
						if (userReply.equalsIgnoreCase("Dangerous")) {
							...
							if (RNG1 < 6) {
								...
								c.clear();
								c.println("You fall in a ditch.");//add loop later
							}	 
						}
							...
							if (userReply.equalsIgnoreCase("Yes")){
								...
								if (userReply.equalsIgnoreCase("Library")){
									...
									if (RNG2 < 6) {
										...
										c.clear();
										c.println("Chad asks if you wnat to go to homecoming and you ace your calculus test.");
									}
								}
								else {
									c.clear();
